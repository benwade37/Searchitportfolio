...
CSRF_TRUSTED_ORIGINS = [
    ...
    "https://www.clickawadey.com",
    "https://clickawadey.com",
]
...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddleware',  # Add this for static file handling on Heroku
...
# Use dj_database_url to configure the database if DATABASE_URL is set (e.g., on Heroku)
